...
<!-- How does Elastic Load Balancing fit into the bigger picture? What talks to it, what does it talk to?
...
```bash
# example command
aws elastic-load-balancing help
```
...
| Criteria | Choose Elastic Load Balancing | Choose Alternative |
|---|---|---|
|  |  |  |
